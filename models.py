...
class CompletedOrder(Base):
	...
	def __init__(self, currency_pair, order_type, amount, price, userid, is_deposit=False, is_withdrawal=False, withdrawal_address=None, transaction_id=None):
		...
		self.withdrawal_complete = False # The object will never be instantiated with a withdrawal already done
